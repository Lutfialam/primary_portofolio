...
<body>
    <div id="app">
        ...
        <section class="padd__top my-5">
            <div class="container mb-5">
                <div class="row">
                    <div class="col-md-5">
                        <h2>Contact Information</h2>
                        <ul>
                            <li>Facebook: <a target="_blank" href="http://facebook.com/lutfi.alamsyah.543">Alamsyah</a>
                            </li>
                            <li>Github : <a target="_blank" href="http://github.com/lutfialam">Lutfialam</a></li>
                            <li>Email : <a target="_blank"
                                    href="https://mail.google.com/mail/?view=cm&fs=1&to=lutfialamsyah1003@gmail.com">lutfialamsyah1003@gmail.com</a>
                            </li>
                            <li>Whatsapp: <a target="_blank" href="https://wa.me/083879926883">083879926883</a></li>
                            <li>Telegram: <a target="_blank" href="https://t.me/lutfialamsyah">Lutfialamsyah</a></li>
                        </ul>
                    </div>
                    <div class="col-md-7">
                        <img src="/undraw_contact_us_15o2.svg" class="img__header">
                    </div>
                </div>
            </div>
        </section>
