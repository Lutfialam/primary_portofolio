...
<body>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href=" {{ route('experience.index') }} ">Experience</a></li>
                                <li><a class="nav-link" href=" {{ route('project.index') }} ">Project</a></li>
                                <li><a class="nav-link" href=" {{ route('portofolio.index') }} ">Portofolio</a></li>
                            </ul>
                        </li>
    ...
    @yield('content__footer')
    @if (Session::has('add__success'))
        <script>
            $('.success', function() {
                iziToast.success({
                    title: 'Success!',
    ...
    @endif
    @if (Session::has('delete__success'))
        <script>
            $('.success', function() {
                iziToast.success({
                    title: 'Success!',
